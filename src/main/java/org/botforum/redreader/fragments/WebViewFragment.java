...
import org.botforum.redreader.views.webview.VideoEnabledWebChromeClient;
import org.botforum.redreader.views.webview.WebViewFixed;
...
public class WebViewFragment extends Fragment implements RedditPostView.PostSelectionListener {
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
		...
		if (mUrl != null) {
			...
			webView.loadDataWithBaseURL("https://botforum.net/", html, "text/html; charset=UTF-8", null, null);
		}
