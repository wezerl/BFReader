...
package org.botforum.redreader.fragments;
...
import org.botforum.redreader.R;
import org.botforum.redreader.account.RedditAccount;
import org.botforum.redreader.account.RedditAccountManager;
import org.botforum.redreader.activities.BugReportActivity;
import org.botforum.redreader.activities.OptionsMenuUtility;
import org.botforum.redreader.activities.SessionChangeListener;
import org.botforum.redreader.adapters.PostListingManager;
import org.botforum.redreader.cache.CacheManager;
import org.botforum.redreader.cache.CacheRequest;
import org.botforum.redreader.cache.downloadstrategy.DownloadStrategy;
import org.botforum.redreader.cache.downloadstrategy.DownloadStrategyAlways;
import org.botforum.redreader.cache.downloadstrategy.DownloadStrategyIfNotCached;
import org.botforum.redreader.cache.downloadstrategy.DownloadStrategyIfTimestampOutsideBounds;
import org.botforum.redreader.cache.downloadstrategy.DownloadStrategyNever;
import org.botforum.redreader.common.AndroidCommon;
import org.botforum.redreader.common.Constants;
import org.botforum.redreader.common.General;
import org.botforum.redreader.common.LinkHandler;
import org.botforum.redreader.common.PrefsUtility;
import org.botforum.redreader.common.RRError;
import org.botforum.redreader.common.RRTime;
import org.botforum.redreader.common.TimestampBound;
import org.botforum.redreader.image.GetImageInfoListener;
import org.botforum.redreader.image.ImageInfo;
import org.botforum.redreader.io.RequestResponseHandler;
import org.botforum.redreader.jsonwrap.JsonBufferedArray;
import org.botforum.redreader.jsonwrap.JsonBufferedObject;
import org.botforum.redreader.jsonwrap.JsonValue;
import org.botforum.redreader.listingcontrollers.CommentListingController;
import org.botforum.redreader.reddit.PostSort;
import org.botforum.redreader.reddit.RedditPostListItem;
import org.botforum.redreader.reddit.RedditSubredditManager;
import org.botforum.redreader.reddit.api.RedditSubredditSubscriptionManager;
import org.botforum.redreader.reddit.api.SubredditRequestFailure;
import org.botforum.redreader.reddit.prepared.RedditParsedPost;
import org.botforum.redreader.reddit.prepared.RedditPreparedPost;
import org.botforum.redreader.reddit.things.RedditPost;
import org.botforum.redreader.reddit.things.RedditSubreddit;
import org.botforum.redreader.reddit.things.RedditThing;
import org.botforum.redreader.reddit.url.PostCommentListingURL;
import org.botforum.redreader.reddit.url.PostListingURL;
import org.botforum.redreader.reddit.url.RedditURLParser;
import org.botforum.redreader.reddit.url.SearchPostListURL;
import org.botforum.redreader.reddit.url.SubredditPostListURL;
import org.botforum.redreader.views.PostListingHeader;
import org.botforum.redreader.views.RedditPostView;
import org.botforum.redreader.views.ScrollbarRecyclerViewManager;
import org.botforum.redreader.views.SearchListingHeader;
import org.botforum.redreader.views.liststatus.ErrorView;
