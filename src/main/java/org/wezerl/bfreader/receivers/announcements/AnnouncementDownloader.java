...
package org.wezerl.bfreader.receivers.announcements;
...
import org.wezerl.bfreader.common.HexUtils;
...
public final class AnnouncementDownloader {
	...
	public static void performDownload(@NonNull final Context context) {
		...
		CacheManager.getInstance(context).makeRequest(new CacheRequest(
				Constants.Reddit.getUri("/s/rr_announcements/new.json?limit=1"),
