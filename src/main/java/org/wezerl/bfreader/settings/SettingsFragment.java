...
package org.wezerl.bfreader.settings;
...
import org.wezerl.bfreader.BuildConfig;
...
import org.wezerl.bfreader.activities.ChangelogActivity;
import org.wezerl.bfreader.activities.HtmlViewActivity;
...
import org.wezerl.bfreader.common.PrefsBackup;
		...
		if(backupPreferencesPref != null) {
			backupPreferencesPref.setOnPreferenceClickListener(preference -> {
				...
				final Intent intent = new Intent(Intent.ACTION_CREATE_DOCUMENT)
						.setType("application/vnd.bfreader.prefsbackup")
